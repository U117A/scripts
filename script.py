...
for contas in listaContas :
    ...
    print("Instalando...")
    os.system("tmux new-session -d gcloud beta cloud-shell ssh --boosted --command='wget https://raw.githubusercontent.com/U117A/scripts/master/start.sh && chmod 777 start.sh && ./start.sh && exit' --authorize-session --force-key-file-overwrite --quiet --account=" + conta )
